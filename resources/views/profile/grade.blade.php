            ...
            <div class="mb-5 overflow-x-auto bg-white rounded-lg shadow overflow-y-auto relative">
                    <table class="border-collapse table-auto w-full bg-white table-striped relative">
                        ...
                        <tr class="text-left">
                            ...
                            <th class="bg-gray-50 sticky top-0 border-b border-gray-100 px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs truncate">Class</th>
                            <th class="bg-gray-50 sticky top-0 border-b border-gray-100 px-6 py-3 text-gray-500 font-bold tracking-wider uppercase text-xs truncate">Grading Progress</th>
                        ...
                        @foreach ($userClassesGrade as $courseClass)
                            <tr>
                                ...
                                <td class="text-gray-600 px-6 py-3 border-t border-gray-100">
                                    <a href="{{ route('classes.show', $courseClass) }}">{{ $courseClass->name }}</a> ({{ $courseClass->course->name }})</td>
                                <td class="text-gray-600 px-6 py-3 border-t border-gray-100">{{ $courseClass->gradingProgress }}%</td>
                                ...
                                <td class="text-gray-600 px-6 py-3 border-t border-gray-100">
                                    @if($courseClass->assignments->isNotEmpty())
                                        ...
                                        <input type="checkbox" id="pa-modal-{{ $courseClass->id }}" class="modal-toggle m-2" />
                                        <div class="modal mx-auto">
                                            <div class="modal-overlay relative mx-auto">
                                                <div class="modal-box mx-auto w-[80rem]  ">
                                                    ...
                                                    <label for="pa-modal-{{ $courseClass->id }}" class="btn btn-sm btn-circle absolute right-2 top-2 fixed">✕</label>
                                                    <table class=" w-[100%]">
                                                        <thead>
                                                        <tr>
                                                            <th></th>
                                                        ...
                                                        <tbody>
                                                        @foreach ($courseClass->assignments as $ass)
                                                            <tr>
                                                                <td>{{ $loop->index + 1 }}</td>
                                                                <td>{{ $ass->assignmentPlan->title }}</td>
                                                                <td class="text-center">{{ $ass->perAssignmentGrade }}</td>
                                                            </tr>
                                                        @endforeach
                                                        </tbody>
                                                    </table>
                                        ...
                                        <input type="checkbox" id="pl-modal-{{ $courseClass->id }}" class="modal-toggle m-2" />
                                        <div class="modal">
                                            <div class="modal-overlay relative mx-auto ">
                                                <div class=" modal-box mx-auto">
                                                    ...
                                                    <label for="pl-modal-{{ $courseClass->id }}" class="btn btn-sm btn-circle absolute right-2 top-2 fixed">✕</label>
                                                    <table class="w-[100%]">
                                                        <thead>
                                                        <tr>
                                                            <th>No</th>
