                        ...
                        <div class="card-body items-center text-center">
                          <div class="card-title text-neutral">Nama Fakultas</div>
                            ...
                            <div class="card-actions mt-2">
                                <button class="btn bg-green-400 hover:bg-white hover:text-green-400 text-white font-bold rounded border-green-400 border-2 hover:border-green-400" type="submit">
                                  Simpan
                                </button>
                                </form>
                                <a href="{{ route('faculties.show', [$faculty]) }}">
                                    <button class="btn bg-red-400 hover:bg-white hover:text-red-400 text-white font-bold rounded border-red-400 border-2 hover:border-red-400">
                                      Cancel
                                    </button>
                                </a>
                            </div>
