                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex items-left justify-left">
                        <form action="{{route('syllabi.ilos.store',[$syllabus])}}" method="post">
                            @csrf
                            <h3 class="font-semibold text-md pt-4 tracking-widest ml-4 lg:ml-14 lg:text-lg  text-black">POSISI</h3>
                            ...
                            @enderror
                            <h3 class="font-semibold text-md pt-4 tracking-widest ml-4 lg:ml-14 lg:text-lg  text-black">DESKRIPSI</h3>
                    ...
                    <br>
                            ...
                            <button type="submit"  name="submit" id="submit" class="mr-4 btn rounded-md hover:bg-slate-200 hover:text-black">submit</button>
                            <a href="{{route ('syllabi.ilos.index',[$syllabus])}}" class="btn btn-outline rounded-md "> Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
