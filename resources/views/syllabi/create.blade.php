...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        {{ Breadcrumbs::render('syllabi.create') }}
                ...
                <form method="POST" action="{{ route('syllabi.store') }}">
                    ...
                    <div class="form-control w-full p-3">
                        ...
                        <select class="select select-bordered w-full max-w-xs" name="course_id">
                            ...
                            @foreach ($courses as $course)
                                <option
                                    value="{{ $course->id }}" {{ (old("course_id") == $course->id ? "selected":"") }}>
                    ...
                    <div class="form-control w-full p-3">
                        ...
                        <input type="text" name="head_of_study_program" placeholder="Head of Study Program"
                               class="input input-bordered w-full max-w-xs" value="{{ old('head_of_study_program') }}"/>
