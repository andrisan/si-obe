    ...
    <body>
         <div class="flex h-screen justify-center items-center bg-indigo-100">
            <div class="m-auto bg-white p-8 rounded-2xl">
                ...
                Learning Plan<span class="bg-blue-100 text-blue-800 text-3xl font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ml-2">EDIT</span>
                </h1>
                <form action="foo/barr">
                    <div class="pb-4">
                        <div class="pb-2"><label for="week_number"><strong class="font-semibold text-gray-900 dark:text-white">Week Number</strong></label></div>
                        <input type="text" placeholder="Week Number" class="input input-bordered w-full max-w-xs" /> <br>
                    </div>
                    <div class="pb-4">
                    <div class="pb-2"><label for="study_material"><strong class="font-semibold text-gray-900 dark:text-white">Study Material</strong></label></div>
