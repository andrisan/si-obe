...
<head>
  ...
  <title>Learning Plans View</title>
</head>
...
<body>
  <div class="grid grid-cols-4 divide-y w-full h-full">
    ...
    <div class="col-span-1 grid grid-flow-row grid-rows-none auto-rows-max divide-y overflow-y-scroll h-full">
      ...
      <div class="grid grid-flow-row grid-rows-none p-5">
        <div class="flex flex-wrap py-2">
          ...
          <label class="px-4">Learning Plans 1</label>
        </div>
        <div class="flex flex-wrap py-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6">
          ...
          <label class="px-4">Learning Plans 2</label>
        </div>
        <div class="flex flex-wrap py-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6">
          ...
          <label class="px-4">Learning Plans 3</label>
        </div>
        <div class="flex flex-wrap py-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6">
          ...
          <label class="px-4">Learning Plans 4</label>
        </div>
        <div class="flex flex-wrap py-2">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-6 h-6">
          ...
          <label class="px-4">Learning Plans 5</label>
        </div>
      </div>
    ...
    <div class="col-span-3 p-10 shadow-xl justify-items-auto overflow-y-auto">
      <h1 class="text-4xl font-semibold text-primary-content">Learning Plans</h1>
