                ...
                <form method="POST" action="{{ route('courses.update', $course) }}">
                    ...
                    <div class="grid grid-cols-2 gap-1">
                        <div class="form-control w-full max-w-xl">
                            ...
                            <select class="select text-neutral input-bordered bg-white w-full max-w-xl" name="study_program" id="study_program">
                                ...
                                @foreach($studyPrograms as $program)
                                    <option value="{{ $program->id }}" {{ ($program->id == $course->study_program_id ? "selected":"") }}>{{ $program->name }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input type="text" class="input text-neutral input-bordered bg-white w-full max-w-xl" name="code" placeholder="Course code" value="{{ old('code', $course->code) }}"/>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input type="text" class="input text-neutral input-bordered bg-white w-full max-w-xl" name="name" value="{{ old('name', $course->name) }}"/>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <textarea class="textarea text-neutral input-bordered bg-white w-full max-w-xl" name="short_description">{{ old('short_description', $course->short_description) }}</textarea>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input type="text" class="input text-neutral input-bordered bg-white w-full max-w-xl" name="course_credit" value="{{ old('course_credit', $course->course_credit) }}" />
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <textarea class="textarea text-neutral input-bordered bg-white w-full max-w-xl" name="minimal_requirement">{{ old('minimal_requirement', $course->minimal_requirement) }}</textarea>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <input type="text" class="input text-neutral input-bordered bg-white w-full max-w-xl" name="lab_credit" value="{{ old('lab_credit', $course->lab_credit) }}" />
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <textarea class="textarea text-neutral input-bordered bg-white w-full max-w-xl" name="study_material_summary">{{ old('study_material_summary', $course->study_material_summary) }}</textarea>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <select class="select text-neutral input-bordered bg-white w-full max-w-xl" name="type" id="type">
                                ...
                                <option {{ $course->type == "mandatory"? "selected": "" }}>Mandatory</option>
                                <option {{ $course->type == "elective"? "selected": "" }}>Elective</option>
                            </select>
                        ...
                        <div class="form-control w-full max-w-xl">
                            ...
                            <textarea class="textarea text-neutral input-bordered bg-white w-full max-w-xl" name="learning_media">{{ old('learning_media', $course->learning_media) }}</textarea>
