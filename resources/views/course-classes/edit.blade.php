                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form action="{{ route('classes.update',[$class]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="container p-4 text-primary mt-2 text-sm">
                                ...
                                <input value ="{{old('name', $class->name)}}" type="text" placeholder="Masukkan Nama Kelas"
                                ...
                                <input value ="{{old('class_code', $class->class_code)}}" type="text" placeholder="Masukkan Kode Kelas"
                                    class="input input-bordered input-ghost input-l w-full max-w-xl mb-2 mt-2"
                                ...
                                <input value ="{{old('creator_user_id', $class->creator_user_id)}}" type="text" placeholder="Masukkan Kode Kelas"
                                    class="input input-bordered input-ghost input-l w-full max-w-xl mb-2 mt-2"
