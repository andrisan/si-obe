                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-control w-full max-w-xs">
                            ...
                            <input type="text" name="password" placeholder="User's email" class="input input-bordered w-full max-w-xs" value="{{ old('password') }}"/>
                        ...
                        <div class="form-control w-full max-w-xs">
                            ...
                            <input type="text" name="password_confirmation" placeholder="User's email" class="input input-bordered w-full max-w-xs" value="{{ old('password_confirmation') }}"/>
