        ...
        <table class="table-fixed  mx-auto">
            <thead class="text-black">
                <tr class="h-10">
                    ...
                    <th rowspan="2" class="w-[50rem] border-x-2 border-t-2 border-black">Sub-Capaian Mata Kuliah</th>
      ...
      <div class="mt-10">
        ...
        <thead class="text-black">
                <tr class="h-10">
                    ...
                    <th class="w-[24rem] border-x-2 border-2 border-black">Jumlah Mahasiswa Tidak Lulus</th>
